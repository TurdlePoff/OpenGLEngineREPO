...
***********************/
void ClothParticle::Process(float _deltaTick)
{
...
***********************/
void ClothParticle::AddForce(glm::vec3 _f)
{
...
* @parameter: _deltaTick
***********************/
void ClothParticle::AddGravity(const glm::vec3 _direction)
{
	AddForce(_direction);
